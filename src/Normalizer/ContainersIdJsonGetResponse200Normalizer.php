...
class ContainersIdJsonGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \WeTheRed\DockerApi\Model\ContainersIdJsonGetResponse200();
        ...
        if (\array_key_exists('State', $data)) {
            $object->setState($this->denormalizer->denormalize($data['State'], 'WeTheRed\\DockerApi\\Model\\ContainerState', 'json', $context));
        }
